  ...
  view (vnode) {
    ...
    return [
      m('.asset-detail',
        ...
        m('p',
          m('div.alert alert-success', 'No recalls - product is safe to consume')),
        ...
        m('p',
          m('div.card',
            m('div.card-body',        
            _row(
              _labelProperty('Previous transaction', _assetLink(getPropertyValue(record, 'refBlocks'))))
        ))),
        ...
        m('p',
          m('div.card',
            m('div.card-body',
              _row(_historyLink())
              // m('a[href="http://localhost:8021/#!/history"]',
              //   // { target: '_blank' },
              //   "Transaction history")
        ))),
